...
<table style="width: 363px; height: 2812px;" border="0" width="213" cellspacing="0" cellpadding="0">
    <colgroup>
        <col style="width: 74px;" span="3" width="71" />
    </colgroup>
    <tbody>
        <tr style="height: 29px;">
            <td style="height: 29px;" width="71"></td>
            <td class="xl66" style="height: 29px;" colspan="2" width="142"><span style="color: #236fa1;"><strong>2021 Summer II Statistics</strong></span></td>
        </tr>
        <tr style="height: 29px;">
            <td style="height: 29px;"></td>
            <td class="xl66" style="height: 29px;" colspan="2">N = 24</td>
        </tr>
        <tr style="height: 29px;">
            <td style="height: 29px;"></td>
            <td class="xl66" style="height: 29px;"><strong>Mean</strong></td>
            <td class="xl66" style="height: 29px;"><strong>SD</strong></td>
        </tr>
        ...
        <tr style="height: 149px;">
            ...
            <td class="xl66" style="text-align: center; height: 149px;" align="right">0.2</td>
        </tr>
        <tr style="height: 125px;">
